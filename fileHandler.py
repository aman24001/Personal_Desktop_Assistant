...
def createFile(text):
	...
	if isContain(text, ["ppt","power point","powerpoint"]):
		...
		appLocation = "C:\\Program Files\\Microsoft Office\\root\\Ofice16\\POWERPNT.exe"

	elif isContain(text, ['excel','spreadsheet']):
		file_name = "sample_file.xsl"
		appLocation = "C:\\Program Files\\Microsoft Office\\root\\Ofice16\\EXCEL.EXE"

	elif isContain(text, ['word','document']):
		file_name = "sample_file.docx"
		appLocation = "C:\\Program Files\\Microsoft Office\\root\\Ofice16\\WINWORD.EXE"
