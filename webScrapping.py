...
def email(rec_email=None, text="Hello, It's T.A.R.S here...", sub='T.A.R.S'):
	if '@gmail.com' not in rec_email: return
	s = smtplib.SMTP('smtp.gmail.com', 587)
	s.starttls()
	s.login("alextestmail055@gmail.com", "testmail1234")
	message = 'Subject: {}\n\n{}'.format(sub, text)
	s.sendmail("alextestmail055@gmail.com", rec_email, message)
	print("Sent")
	s.quit()
